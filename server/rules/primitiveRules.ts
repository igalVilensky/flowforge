...
export const primitiveRules: readonly PrimitiveRule[] = [
  ...
  {
    primitive: "approval",
    phrases: ["approve", "review", "confirm", "sign off", "human approval", "manual review"],
    rough_action: "Ask a human to review before execution",
  ...
  },
  {
    ...
    phrases: ["create record", "create task", "create ticket", "log", "save", "update record", "internal tag"],
